...
#This is a wrapper around the provided PulseBlasterUSB package provided on their website:
#https://www.spincore.com/support/SpinAPI_Python_Wrapper/Python_Wrapper_Main.shtml
...
#This may also work on ESR models, but it hasn't been tested on them.
